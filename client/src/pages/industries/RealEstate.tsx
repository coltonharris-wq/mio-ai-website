        ...
        <div className="container">
          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 mb-6">
              <div className="p-4 bg-primary/10 rounded-lg"><Home className="w-16 h-16 text-primary" /></div>
              <h1 className="text-5xl md:text-7xl font-black" style={{ fontFamily: 'var(--font-display)' }}>Real Estate AI Solutions</h1>
            </div>
            <p className="text-2xl mb-8 text-muted-foreground leading-relaxed">AI-powered automation for real estate professionals. Manage listings, schedule showings, and nurture leads 24/7 while you focus on closing deals.</p>
      ...
      <section className="py-24 bg-background">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="brutalist-border brutalist-shadow bg-background p-8 transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-none"><Calendar className="w-12 h-12 text-primary mb-4" /><h3 className="text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-display)' }}>Automated Showing Scheduling</h3><p className="text-muted-foreground leading-relaxed">AI books property tours, sends reminders, and handles rescheduling. Never miss a potential buyer due to scheduling conflicts.</p></Card>
            <Card className="brutalist-border brutalist-shadow bg-background p-8 transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-none"><Users className="w-12 h-12 text-primary mb-4" /><h3 className="text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-display)' }}>Lead Nurturing</h3><p className="text-muted-foreground leading-relaxed">Automated follow-ups with prospects at every stage. Convert 40% more leads with timely, personalized communication.</p></Card>
            <Card className="brutalist-border brutalist-shadow bg-background p-8 transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-none"><TrendingUp className="w-12 h-12 text-primary mb-4" /><h3 className="text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-display)' }}>Market Analytics</h3><p className="text-muted-foreground leading-relaxed">AI analyzes market trends, comp prices, and neighborhood data. Make data-driven pricing decisions instantly.</p></Card>
            <Card className="brutalist-border brutalist-shadow bg-background p-8 transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-none"><MessageSquare className="w-12 h-12 text-primary mb-4" /><h3 className="text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-display)' }}>Client Communication</h3><p className="text-muted-foreground leading-relaxed">Automated property updates, price changes, and new listing alerts keep clients engaged throughout their search.</p></Card>
            <Card className="brutalist-border brutalist-shadow bg-background p-8 transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-none"><FileText className="w-12 h-12 text-primary mb-4" /><h3 className="text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-display)' }}>Document Management</h3><p className="text-muted-foreground leading-relaxed">Streamline contracts, disclosures, and compliance documents. Reduce closing time by 30% with automated workflows.</p></Card>
            <Card className="brutalist-border brutalist-shadow bg-background p-8 transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-none"><Home className="w-12 h-12 text-primary mb-4" /><h3 className="text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-display)' }}>CRM Integration</h3><p className="text-muted-foreground leading-relaxed">Seamlessly integrates with Zillow, Realtor.com, MLS systems, and popular real estate CRMs like Follow Up Boss.</p></Card>
          </div>
        </div>
      </section>
      <section className="py-24 bg-foreground text-background">
        <div className="container text-center">
          <h2 className="text-4xl md:text-6xl font-black mb-6" style={{ fontFamily: 'var(--font-display)' }}>Ready to close more deals?</h2>
          <p className="text-xl md:text-2xl mb-10 text-background/80 max-w-3xl mx-auto">Join real estate companies using AI to deliver better results and operational efficiency.</p>
